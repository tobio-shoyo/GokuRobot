...
if ENV:
    ...
    NO_LOAD = os.environ.get("NO_LOAD", "sed").split()
...
telethn = TelegramClient("XForceSTB", API_ID, API_HASH)
...
from XForceSTB.modules.helper_funcs.handlers import (CustomCommandHandler,
